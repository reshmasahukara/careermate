            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl py-2.5 px-3 text-sm focus:outline-none focus:border-blue-500 pl-9 transition-colors"
                  />
              ...
              <div className="space-y-2">
                ...
                <select
                  ...
                  className="w-full bg-[#F8FAFC] border border-[#E2E8F0] rounded-xl py-2.5 px-3 text-sm focus:outline-none focus:border-blue-500 transition-colors"
                >
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-col gap-2">
                  <label className="flex items-center gap-2 cursor-pointer text-sm text-[#64748B] hover:text-[#0F172A]">
                    <input type="radio" name="remote" value="" checked={filterRemote === ""} onChange={(e) => setFilterRemote(e.target.value)} className="accent-blue-600" /> All
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer text-sm text-[#64748B] hover:text-[#0F172A]">
                    <input type="radio" name="remote" value="remote" checked={filterRemote === "remote"} onChange={(e) => setFilterRemote(e.target.value)} className="accent-blue-600" /> Remote Only
                  </label>
                  <label className="flex items-center gap-2 cursor-pointer text-sm text-[#64748B] hover:text-[#0F172A]">
                    <input type="radio" name="remote" value="onsite" checked={filterRemote === "onsite"} onChange={(e) => setFilterRemote(e.target.value)} className="accent-blue-600" /> On-site / Hybrid
                  </label>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 gap-4">
                {jobs.map((job) => {
                  ...
                  return (
                    <div
                      key={job.id}
                      className="group bg-white border border-[#E2E8F0] rounded-[20px] p-6 hover:shadow-md hover:border-blue-200 transition-all cursor-pointer flex flex-col gap-4 relative"
                    >
                      <button 
                        onClick={(e) => toggleSaveJob(e, job.id)}
                        className="absolute top-6 right-6 p-2 rounded-full hover:bg-slate-50 text-slate-400 hover:text-blue-600 transition-colors z-10"
                      >
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 pr-12">
                        <div className="flex items-start gap-4">
                          ...
                          <div>
                            <h3 className="text-lg font-bold text-[#0F172A] group-hover:text-blue-600 transition-colors leading-tight">
                              {job.title}
                            </h3>
                      ...
                      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-4 border-t border-[#E2E8F0]/60">
                        ...
                        <div className="shrink-0 w-full sm:w-auto">
                          <a
                            ...
                            className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-bold py-2.5 px-6 rounded-[10px] shadow-sm transition-all text-sm flex items-center justify-center gap-2"
                          >
                            Apply
